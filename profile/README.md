...
| • **AI**: `OpenAI API` <br/> • **Analysis**: `Plotly`  <br/> **DB**: `MySQL` | **DB**: `Schema Update (lat/lon)` <br> • **Filtering**: `조건 기반 매물 선별` <br> • **Map**: `버블 지도 시각화(Folium)` • <br> **UI**: `Price Filter Bar`|  • **Analytics**: `Monthly Payment` <br> **Chart**: `Boxplot` |• **UI/UX**: `Main Page Layout` <br> • **Form**: `User Input` |
